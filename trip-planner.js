...
- Format: [📍 Location Name](https://www.google.com/maps/search/Location+Name+Area/@Latitude,Longitude,17z)
- Example: [📍 French Toast Fort Kochi](https://www.google.com/maps/search/French+Toast+Fort+Kochi/@9.9654,76.2423,17z)
- Replace spaces with + in the search term
- Use exact coordinates from Latitude,Longitude columns in database
- Always include the 📍 map pin icon
...
6. For each location, provide:
   ...
   - Clickable Google Maps link: [📍 Location Name](https://www.google.com/maps/search/Location+Name+Address/@Latitude,Longitude,17z)
   - Estimated costs
...
For EVERY location mentioned, create clickable Google Maps links using the exact latitude and longitude from the database:
- Format: [📍 Location Name](https://www.google.com/maps/search/Location+Name+Area/@Latitude,Longitude,17z)
- Example: [📍 Milano Ice Cream Ernakulam](https://www.google.com/maps/search/Milano+Ice+Cream+Ernakulam/@9.9350,76.2680,17z)
- Replace spaces with + in the search term
- Use exact coordinates from Latitude,Longitude columns in database
- Always include the 📍 map pin icon
...
For EVERY location mentioned, create clickable Google Maps links using the exact latitude and longitude from the database:
- Format: [📍 Location Name](https://www.google.com/maps/search/Location+Name+Area/@Latitude,Longitude,17z)
- Example: [📍 Seagull Fort Kochi](https://www.google.com/maps/search/Seagull+Fort+Kochi/@9.9655,76.2422,17z)
- Replace spaces with + in the search term
- Use exact coordinates from Latitude,Longitude columns in database
- Always include the 📍 map pin icon
...
- Clickable Google Maps link format: [📍 Location](https://www.google.com/maps/search/Location+Area/@Lat,Long,17z)
- Best visiting times
...
- Clickable Google Maps link: [📍 Location Name](https://www.google.com/maps/search/Location+Area+Kochi/@Latitude,Longitude,17z)
...
For EVERY location mentioned, create clickable Google Maps links using the exact latitude and longitude from the database:
- Format: [📍 Location Name](https://www.google.com/maps/search/Location+Name+Area/@Latitude,Longitude,17z)
- Example: [📍 Mattancherry Palace Kochi](https://www.google.com/maps/search/Mattancherry+Palace+Kochi/@9.9579,76.2599,17z)
- Replace spaces with + in the search term
- Use exact coordinates from Latitude,Longitude columns in database
- Always include the 📍 map pin icon
...
For EVERY location mentioned, create clickable Google Maps links using the exact latitude and longitude from the database:
- Format: [📍 Location Name](https://www.google.com/maps/search/Location+Name+Area/@Latitude,Longitude,17z)
- Example: [📍 Kerala Kathakali Centre Fort Kochi](https://www.google.com/maps/search/Kerala+Kathakali+Centre+Fort+Kochi/@9.9656,76.2425,17z)
- Replace spaces with + in the search term
- Use exact coordinates from Latitude,Longitude columns in database
- Always include the 📍 map pin icon
...
- Clickable Google Maps link: [📍 Location Name](https://www.google.com/maps/search/Location+Name+Area/@Latitude,Longitude,17z)
...
For EVERY location mentioned, create clickable Google Maps links using the exact latitude and longitude from the database:
- Format: [📍 Location Name](https://www.google.com/maps/search/Location+Name+Area/@Latitude,Longitude,17z)
- Example: [📍 Karthiyani Fish Curry Meals Ernakulam](https://www.google.com/maps/search/Karthiyani+Fish+Curry+Meals+Ernakulam/@9.9400,76.2800,17z)
- Replace spaces with + in the search term
- Use exact coordinates from Latitude,Longitude columns in database
- Always include the 📍 map pin icon
...
For EVERY location mentioned, create clickable Google Maps links using the exact latitude and longitude from the database:
- Format: [📍 Location Name](https://www.google.com/maps/search/Location+Name+Area/@Latitude,Longitude,17z)
- Example: [📍 Kashi Art Cafe Fort Kochi](https://www.google.com/maps/search/Kashi+Art+Cafe+Fort+Kochi/@9.9652,76.2428,17z)
- Replace spaces with + in the search term
- Use exact coordinates from Latitude,Longitude columns in database
- Always include the 📍 map pin icon
